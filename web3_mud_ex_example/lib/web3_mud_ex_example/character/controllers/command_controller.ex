defmodule Web3MudExExample.Character.CommandController do
  use Kalevala.Character.Controller

  require Logger

  alias Kalevala.Output.Tags
  alias Web3MudExExample.Character.Commands
  alias Web3MudExExample.Character.CommandView
  alias Web3MudExExample.Character.Events
  alias Web3MudExExample.Character.IncomingEvents
