defmodule Web3MudExExample.Character.Events do
  @moduledoc false
  ...
  alias Web3MudExExample.Character.EmoteEvent
  alias Web3MudExExample.Character.SayEvent
  alias Web3MudExExample.Character.TellEvent
  alias Web3MudExExample.Character.WhisperEvent

  scope(Web3MudExExample.Character) do
...
defmodule Web3MudExExample.Character.IncomingEvents do
  @moduledoc false
...
defmodule Web3MudExExample.Character.NonPlayerEvents do
  @moduledoc false
