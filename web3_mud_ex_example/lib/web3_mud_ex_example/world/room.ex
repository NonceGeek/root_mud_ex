defmodule Web3MudExExample.World.Room do
  @moduledoc """
  ...
  alias Web3MudExExample.RoomChannel
  alias Web3MudExExample.World.Items
  alias Web3MudExExample.World.Room.Events
  ...
  defimpl Kalevala.World.Room.Callbacks do
    ...
    alias Web3MudExExample.World.Room
...
defmodule Web3MudExExample.World.Room.Events do
  @moduledoc false

  use Kalevala.Event.Router

  scope(Web3MudExExample.World.Room) do
...
defmodule Web3MudExExample.World.Room.ForwardEvent do
...
defmodule Web3MudExExample.World.Room.RandomExitEvent do
  import Kalevala.World.Room.Context
...
defmodule Web3MudExExample.World.Room.LookEvent do
  import Kalevala.World.Room.Context

  alias Web3MudExExample.Character.LookView
  alias Web3MudExExample.World.Items
...
defmodule Web3MudExExample.World.Room.MapEvent do
  import Kalevala.World.Room.Context

  alias Web3MudExExample.Character.MapView
  alias Web3MudExExample.World.ZoneCache
...
defmodule Web3MudExExample.World.Room.ContextEvent do
  import Kalevala.World.Room.Context

  alias Kalevala.Verb
  alias Kalevala.World.Item
  alias Web3MudExExample.Character.ContextView
  alias Web3MudExExample.World.Items
...
defmodule Web3MudExExample.World.Room.SayEvent do
  import Kalevala.World.Room.Context
...
defmodule Web3MudExExample.World.Room.TellEvent do
  import Kalevala.World.Room.Context
  ...
  defp find_player_character(name) do
    characters = Web3MudExExample.Character.Presence.characters()
...
defmodule Web3MudExExample.World.Room.WhisperEvent do
  import Kalevala.World.Room.Context
...
defmodule Web3MudExExample.World.Room.NotifyEvent do
  import Kalevala.World.Room.Context
