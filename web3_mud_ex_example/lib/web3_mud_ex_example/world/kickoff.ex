defmodule Web3MudExExample.World.Kickoff do
  @moduledoc """
  ...
  defp start_zone(zone) do
    config = %{
      supervisor_name: Web3MudExExample.World,
      callback_module: Web3MudExExample.World.Zone
    }
  ...
  defp start_room(room) do
    config = %{
      ...
      callback_module: Web3MudExExample.World.Room
    }
  ...
  defp start_character(character) do
    config = [
      ...
      initial_controller: Web3MudExExample.Character.SpawnController,
  ...
  defp cache_item(item) do
    Web3MudExExample.World.Items.put(item.id, item)
  end
