defmodule Web3MudExExample.Output.Macros do
  @moduledoc """
...
defmodule Web3MudExExample.Output.SemanticColors do
  @moduledoc """
  ...
  import Web3MudExExample.Output.Macros, only: [color: 2]
...
defmodule Web3MudExExample.Output.AdminTags do
  @moduledoc """
  ...
  import Web3MudExExample.Output.Macros, only: [metadata: 3]
...
defmodule Web3MudExExample.Output.Tooltips do
  @moduledoc """
  ...
  # import Web3MudExExample.Output.Macros, only: [tooltip: 2]
...
defmodule Web3MudExExample.Output.Commands do
  @moduledoc """
