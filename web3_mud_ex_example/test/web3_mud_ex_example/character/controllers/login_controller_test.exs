defmodule Web3MudExExample.Character.LoginControllerTest do
  use Web3MudExExample.ConnCase

  alias Web3MudExExample.Character.LoginController
  ...
  describe "requesting the password" do
    test "after the username is the password" do
      ...
      assert conn.private.next_controller == Web3MudExExample.Character.CharacterController
  ...
  describe "switching to registration" do
    test "confirming registering the character" do
      ...
      assert conn.private.next_controller == Web3MudExExample.Character.RegistrationController
