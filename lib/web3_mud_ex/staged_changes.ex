defmodule Web3MUDEx.Types.Atom do
  @moduledoc """
...
defmodule Web3MUDEx.Types.Term do
  @moduledoc """
...
defmodule Web3MUDEx.StagedChanges.TempRecord do
...
defmodule Web3MUDEx.StagedChanges.StagedChange do
  @moduledoc """
  ...
  schema "abstract table: staged_changes" do
    field(:attribute, Web3MUDEx.Types.Atom)
    field(:value, Web3MUDEx.Types.Term)

    belongs_to(:struct, Web3MUDEx.StagedChanges.TempRecord)
...
defmodule Web3MUDEx.StagedChanges do
  @moduledoc """
  ...
  @schemas %{
    "room_staged_changes" => Web3MUDEx.Rooms.Room,
    "zone_staged_changes" => Web3MUDEx.Zones.Zone
  }
